...
class ProfileOrAppointmentViewScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final otherPerson = isDoctorRole(selectedRole) ? appointment.patient : appointment.doctor;
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            DetailsInfoWidget(
              title: isDoctorRole(selectedRole) ? "Patient Info" : "Doctor Info",
              data: {
            ...
            if (isLabRole(selectedRole)) ...[Tests()],
            ...
            if (isPatientRole(selectedRole) || isDoctorRole(selectedRole)) ...[
              Padding(
                ...
                Expanded(
                  ...
                  child: Column(
                    children: [
                      ...
                      // Patient/Doctor Info
                      _buildWebDetailsCard(
                        isDoctorRole(selectedRole) ? "Patient Info" : "Doctor Info",
