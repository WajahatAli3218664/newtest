...
// }
  ...
  void initState() {
    super.initState();
   final role = ref.read(authProvider).userRole;
    controller = TabController(length: isInstructorRole(role) ? 1 : 3, vsync: this);
  }
   ...
   final role = ref.read(authProvider).userRole;
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: CustomText(text: coursesLabelForRole(role),
      ...
      body: Center(
        ...
        crossAxisAlignment: CrossAxisAlignment.center,
          ...
          SizedBox(
            ...
            tabs: [
              CustomText(
                text: isPatientEducationRole(role) ? "All Programs" : "All Courses",
           ...
           if(isInstructorRole(role)) ...[
             ...
             SizedBox(width: Utils.windowWidth(context) * 0.33,),],
            if(!isInstructorRole(role)) ...[CustomText(
                text: isPatientEducationRole(role) ? "Assigned" : "My Purchase",
                padding: EdgeInsets.only(bottom:5),
                width: Utils.windowWidth(context) * 0.33,
                textAlign: TextAlign.center,
              ),
              CustomText(
                ...
                width: Utils.windowWidth(context) * 0.33,
                textAlign: TextAlign.center,
                text: isPatientEducationRole(role) ? "Progress" : "Certificates",
              ),]
            ],
                    ),
          ),   
                ...
                child: Row(
                  ...
                  children: [
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(isPatientEducationRole(role) ? "Explore your care programs" : "Find Your Next Course", style: TextStyle(fontSize: 24, fontWeight: FontWeight.w700, fontFamily: "Gilroy-Bold", color: Color(0xFF1E293B))),
                        SizedBox(height: 8),
                        Text(isPatientEducationRole(role) ? "Programs prescribed or recommended as part of your care plan." : "Discover amazing topics to enhance your skills and career.", style: TextStyle(fontSize: 15, color: Color(0xFF64748B))),
                      ],
                    ),
                    SizedBox(
                      width: 350,
                      child: Container(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            hintText: searchHintForRole(role),
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: TabBar(
                    ...
                    tabs: [
                      Tab(text: isPatientEducationRole(role) ? "All Programs" : "All Courses"),
                      if (!isInstructorRole(role)) Tab(text: isPatientEducationRole(role) ? "Assigned" : "My Purchase"),
                      if (!isInstructorRole(role)) Tab(text: isPatientEducationRole(role) ? "Progress" : "Certificates"),
                    ],
                  ),
                ),
              ),
