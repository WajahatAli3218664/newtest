    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: [
            Tab(text: assignedProgramsLabelForRole(role)),
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              isPatientEducationRole(role) ? 'No health programs assigned yet' : 'No enrolled courses yet',
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          (course['title'] ?? course['name'] ?? (isPatientEducationRole(role) ? 'Untitled program' : 'Untitled course')).toString(),
