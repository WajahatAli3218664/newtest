    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: const Text('Unable to load dashboard right now. Please try again.'),
      ...
      children: [
        ...
        GridView.count(
          ...
          children: [
            ...
            _buildActionCard('Incoming Orders', Icons.inbox_rounded, const Color(0xFF3B82F6), () {
            ...
            _buildActionCard('Upload Reports', Icons.upload_file_rounded, const Color(0xFFF59E0B), () {}),
          ],
        ),
      ],
    );
