        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              SizedBox(height: ScallingConfig.scale(20)),
              SectionHeader(
                title: coursesLabelForRole("Student"),
                width: Utils.windowWidth(context) * 0.9,
                onActionTap: () {
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Explore your care programs, partner labs and next care steps.",
                      style: TextStyle(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                _SectionHeader(
                  title: coursesLabelForRole("Student"),
                  subtitle: "Browse assigned and recommended programs",
